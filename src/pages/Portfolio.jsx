        ...
        <div className="wrapper">
          <div className="text-center max-w-3xl mx-auto mb-16" data-aos="fade-up">
            ...
            <p className="desc text-white/70">
              ...
              From web and mobile applications to AI solutions and blockchain implementations, 
              we've helped businesses transform their digital presence and achieve their goals.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16" data-aos="fade-up">
            <div className="bg-white/5 rounded-lg p-6 text-center hover:bg-primary/20 transition-all duration-300">
              ...
              <div className="text-white/80 font-medium">Completed Projects</div>
            </div>
            <div className="bg-white/5 rounded-lg p-6 text-center hover:bg-primary/20 transition-all duration-300">
